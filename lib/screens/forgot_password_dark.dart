...
class ForgotPasswordDark extends StatefulWidget {
  ...
  @override
  State<ForgotPasswordDark> createState() => _ForgotPasswordDarkState();
}

class _ForgotPasswordDarkState extends State<ForgotPasswordDark> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              Image.asset('assets/images/logo_fuelix_2.png', width: 120),
